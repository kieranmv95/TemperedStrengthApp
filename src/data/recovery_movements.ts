import type { RecoveryMovement } from '@/src/types/recovery';

export const recoveryMovements = {
  achilles_and_lower_leg: {
    id: 'achilles_and_lower_leg',
  ...
  adductors_inner_thigh: {
    id: 'adductors_inner_thigh',
  ...
  banded_monster_walks: {
    id: 'banded_monster_walks',
  ...
  clamshells_with_band: {
    id: 'clamshells_with_band',
  ...
  doorframe_pec_stretch: {
    id: 'doorframe_pec_stretch',
  ...
  downward_dog_with_pedalling: {
    id: 'downward_dog_with_pedalling',
  ...
  finger_extensions_with_band: {
    id: 'finger_extensions_with_band',
  ...
  foam_roller_it_band_outer_thigh: {
    id: 'foam_roller_it_band_outer_thigh',
  ...
  foam_roller_t_spine_extension: {
    id: 'foam_roller_t_spine_extension',
  ...
  hip_90_90_with_forward_fold: {
    id: 'hip_90_90_with_forward_fold',
  ...
  it_band_and_outer_quad: {
    id: 'it_band_and_outer_quad',
  ...
  it_band_and_outer_thigh: {
    id: 'it_band_and_outer_thigh',
  ...
  kneeling_hip_flexor_stretch_with_reach: {
    id: 'kneeling_hip_flexor_stretch_with_reach',
  ...
  low_lunge_with_thoracic_rotation: {
    id: 'low_lunge_with_thoracic_rotation',
  ...
  palm_down_forearm_stretch: {
    id: 'palm_down_forearm_stretch',
  ...
  palm_up_forearm_stretch: {
    id: 'palm_up_forearm_stretch',
  ...
  prayer_stretch_lat_t_spine: {
    id: 'prayer_stretch_lat_t_spine',
  ...
  prayer_stretch_reverse_prayer: {
    id: 'prayer_stretch_reverse_prayer',
  ...
  rear_delts_and_teres: {
    id: 'rear_delts_and_teres',
  ...
  reverse_wrist_circles_knuckles_down: {
    id: 'reverse_wrist_circles_knuckles_down',
  ...
  rhomboids_and_mid_traps: {
    id: 'rhomboids_and_mid_traps',
  ...
  supine_windshield_wipers: {
    id: 'supine_windshield_wipers',
  ...
  terminal_knee_extension_with_band: {
    id: 'terminal_knee_extension_with_band',
  ...
  thenar_and_hypothenar_hand_muscles: {
    id: 'thenar_and_hypothenar_hand_muscles',
  ...
  upper_traps_and_neck_base: {
    id: 'upper_traps_and_neck_base',
  ...
  wrist_weight_shifting_hands_on_floor: {
    id: 'wrist_weight_shifting_hands_on_floor',
...
} as const satisfies Record<string, RecoveryMovement>;

export type RecoveryMovementId = keyof typeof recoveryMovements;

export function getRecoveryMovement(id: RecoveryMovementId): RecoveryMovement {
  return recoveryMovements[id];
}
